...
document.addEventListener('mouseup', function (e) {
  ...
  if (selection.type === 'Range') {
    var text = getHighlightText(); // TODO read the click point, sync to background.js
...
var APP_ID = '20220801001290121';
var KEY = 'yDr87UOd8xxpPYC0JjES';

var translate = function translate(q) {
